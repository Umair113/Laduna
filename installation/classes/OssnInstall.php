						...
						foreach($sql_statements as $statement) {
								...
								if(!empty($statement)) {
										try {
												...
												pg_query($this->dbconnect(),$statement);
										}
										catch(Exception $e) {
												$errors[] = $e->getMessage();
										}
...
*/
          ...
          $xhost = "host=".$this->dbhost;
          $xport = "port=".$this->dbport;
          $xdbname = "dbname=".$this->dbname;
          $xuser = "user=".$this->dbusername;
          $xpassword = "password=".$this->dbpassword;
